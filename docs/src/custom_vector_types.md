...
* `create_hdf5_vector(style::MyNewHDF5VectorStorageStyle, group, name::AbstractString, el_type; kwargs...)`
...
* `copy_to_hdf5_vector(style::MyNewHDF5VectorStorageStyle, group, name::AbstractString, collection; kwargs...)`
